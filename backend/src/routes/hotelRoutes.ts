...
import { createHotel, getHotelByIdOrSlug, getHotelDetails ,updateHotelById, uploadImages, uploadRoomImages } from '../controllers/hotelController';
...
router.get('/hotel/:slug/:id', getHotelDetails); // Made a new api for FrontEnd
